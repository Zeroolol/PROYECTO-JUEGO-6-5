...
@onready var ui_control = get_node("/root/Tutorial/UI")  # Asegúrate de apuntar a tu nodo de UI
...
func show_instructions(text: String):
	ui_control.update_mission(text)  # Asegúrate de que update_mission esté en el script de la UI
...
func _physics_process(delta):
	...
	if direction:
		...
		ui_control.update_mission("")  # Llamar a la función para ocultar el texto
